    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner )
    {
        ...
        if (student != null) {
            ...
            if (student.getEnrolledCourses().size() == 0) {
                System.out.println("This student has no course yet!");
                return;
            }
            ...
            studentService.addGrade(student.getId(), courseId, grade);
        }

    }

    //Added method for option 3
